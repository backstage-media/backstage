...
class CommentsController extends Controller
{
    ...
    */
    ...
    public function add(Request $request)
    {
        ...
        // En caso de tener un contrato con alguien, mandamos notificacion.

        //In case notification is generated by a content creator.

        if ($user_type == 1) {
            $contracts = $contractController->creator_has_contract($profile);
            if ($contracts > 0) {
                ...
                if ($manager_user != null) {
                    ...
                    $notification->message = 'Nuevo comentario en el video "' . $video_title . '": ' . $commentText;
            ...
            $contracts = $contractController->manager_has_contract($profile);
            if ($contracts > 0) {
